...
export const NICHES: Niche[] = [
  ...
  },
  {
    ...
    promise: "Десять женских форумов плюс ленты: пара, семья, доверие, развод, границы.",
    color: "#fb7185",
    keywords: [
      ...
      "husband", "wife", "girlfriend", "boyfriend", "измен", "ревност",
      "свекров", "парн", "девушк", "роман", "breakup", "cheating",
      "жена", "муж", "чувства", "toxic", "токсич",
    ],
  },
  {
    id: "health",
